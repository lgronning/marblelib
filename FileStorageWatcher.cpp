...
FileStorageWatcherThread::FileStorageWatcherThread( QString dataDirectory, QObject *parent )
    : QObject( parent ),
...
FileStorageWatcher::FileStorageWatcher( QString dataDirectory, QObject * parent )
    : QThread( parent ),
      m_dataDirectory(std::move( dataDirectory ))
{

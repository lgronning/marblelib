...
#include "geodata/scene/GeoSceneSection.h"
...
GeoSceneSection::GeoSceneSection( QString  name )
    : m_name(std::move( name )),
      m_heading( QLatin1String("") ),
      m_connectTo( QLatin1String("") ),
      m_radio( QLatin1String("") ),
      m_checkable( false ),
      m_spacing( 12 )
{
}

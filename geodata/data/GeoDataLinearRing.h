...
*/
    explicit GeoDataLinearRing( const QVector<GeoDataCoordinates> &points, TessellationFlags f = NoTessellation, const QVector<double> &messure = QVector<double>(), const QVector<double> &messureInfo = QVector<double>() );
    explicit GeoDataLinearRing( const QVector<QPointF> &points, TessellationFlags f = NoTessellation, const QVector<double> &messure = QVector<double>(), const QVector<double> &messureInfo = QVector<double>() );
    explicit GeoDataLinearRing(const QVector<QwtPoint3D> &points, TessellationFlags f = NoTessellation, const QVector<double> &messure = QVector<double>(), const QVector<double> &messureInfo = QVector<double>() );
    explicit GeoDataLinearRing( );

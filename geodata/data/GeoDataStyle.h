...
class GEODATA_EXPORT GeoDataStyle : public GeoDataStyleSelector
{
  public:
    ...
    /// set the point style
    void setPointStyle( const GeoDataPointStyle& style );
    /// Return the point style of this style
    GeoDataPointStyle& pointStyle();
    const GeoDataPointStyle& pointStyle() const;
    /// set the line style
    void setSpectroStyle( const GeoDataSpectroStyle& style );
    /// Return the label style of this style
    GeoDataSpectroStyle& spectroStyle();
    const GeoDataSpectroStyle& spectroStyle() const;

    bool
    useAntialising() const;

    void
    setUseAntialising(bool value);

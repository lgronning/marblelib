...
const char* GeoDataPointStyleType = "GeoDataPointStyleType";
...
const char* GeoDataMultiLineStringType = "GeoDataMultiLineString";
...
const char* GeoDataMultiPointType = "GeoDataMultiPoint";
const char* GeoDataPolygonType = "GeoDataPolygon";
const char* GeoDataMultiPolygonType = "GeoDataMultiPolygon";
...
const char* GeoDataSpectroStyleType = "GeoDataSpectroStyle";
}

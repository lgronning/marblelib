...
GeoNode* DgmlPenTagHandler::parse(GeoParser& parser) const
{
    ...
    if ( !style.isEmpty() ) {
        if ( style == QLatin1String("nopen") ) pen.setStyle( Qt::NoPen );
        if ( style == QLatin1String("solidline") ) pen.setStyle( Qt::SolidLine ); 
        if ( style == QLatin1String("dashline") ) pen.setStyle( Qt::DashLine ); 
        if ( style == QLatin1String("dotline") ) pen.setStyle( Qt::DotLine ); 
        if ( style == QLatin1String("dashdotline") ) pen.setStyle( Qt::DashDotLine ); 
        if ( style == QLatin1String("dashdotdotline") ) pen.setStyle( Qt::DashDotDotLine ); 
    }

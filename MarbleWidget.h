...
#include "geodata/data/GeoDataLookAt.h"
...
class MARBLE_EXPORT MarbleWidget : public QWidget
{
 ...
 public:
    ...
    MarbleWidgetPopupInfo *popupMenu();
    ...
    void
    setPopupLayer(PopupLayer* popupLayer);
...
//    int projection() const;
 ...
 public Q_SLOTS:
    ...
    void setSelectedFeatures( const QVector<GeoDataFeature*>& features );
 ...
 Q_SIGNALS:
    ...
    void mouseMoveGeoPosition( const GeoDataCoordinates& );

    void mouseClickGeoPosition( const GeoDataCoordinates &);
    ...
    void selectedPlacemarksChanged( const GeoDataCoordinates& coordinate );
...
class MarbleWidgetPrivate
{
 public:
    ...
    MarbleWidgetPopupInfo *m_popupmenu;

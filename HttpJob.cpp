...
{
 public:
    HttpJobPrivate( QUrl  sourceUrl, QString  destFileName,
                    QString id, QNetworkAccessManager *networkAccessManager );
...
HttpJobPrivate::HttpJobPrivate( QUrl  sourceUrl, QString  destFileName,
                                QString id, QNetworkAccessManager *networkAccessManager )
    : m_sourceUrl(std::move( sourceUrl )),
      m_destinationFileName(std::move( destFileName )),
      m_initiatorId(std::move( id )),
      m_trialsLeft( 3 ),

...
#include "geodata/data/GeoDataCoordinates.h"       // In geodata/data/
...
class MARBLE_EXPORT MarbleMap : public QObject
{
 ...
 public:
    ...
    const GeoDataFeature *whichFeatureAt( const QPoint& ) const;
 ...
 Q_SIGNALS:
    ...
    void
    mouseMoveGeoPosition( GeoDataCoordinates );

    void
    mouseClickGeoPosition( GeoDataCoordinates );

    void
    framesPerSecond( qreal fps );
     ...
     */
    void
    repaintNeeded( const QRegion& dirtyRegion = QRegion() );
     ...
     */
    void
    visibleLatLonAltBoxChanged( const GeoDataLatLonAltBox& visibleLatLonAltBox );
     ...
     */
    void
    renderPluginInitialized( RenderPlugin *renderPlugin );

    void
    selectedPlacemarksChanged( const GeoDataCoordinates &coordinate);

    void
    highlightPlacemarksChanged( const GeoDataCoordinates &coordinate);

    void
    viewContextChanged(ViewContext viewContext);
 ...
 private:
    ...
    Q_PRIVATE_SLOT( d, void handleHighlight(const GeoDataCoordinates &) );
    Q_PRIVATE_SLOT( d, void handleSelected(const GeoDataCoordinates &) );
...
public:
    ...
    void handleSelected(const GeoDataCoordinates &coordinate);
    void handleHighlight(const GeoDataCoordinates &coordinate);

...
class MARBLE_EXPORT ViewportParams
{
 public:
    ...
    bool resolves ( const GeoDataLatLonBox &latLonBox, qreal pixel = 0.1 ) const;

    bool resolves ( const GeoDataLatLonAltBox &latLonAltBox, qreal pixel = 0.1, qreal altitude = 10000.0 ) const;
    ...
    bool resolves (double lon1, double lat1 , double lon2, double lat2) const;

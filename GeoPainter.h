...
*/
    ...
    /*!
        \brief Set tje map quality.
    */
     void
     setMapQuality(MapQuality quality);
...
*/
    ...
    Q_DECLARE_FLAGS(LabelStyles, LabelStyle)

    QRectF
    labelRect(const QString &text, const QFont &labelFont, LabelStyles labelStyle);

    void
    drawLabelText(const QRectF &labelRect, const QString &text, const QFont &labelFont, LabelStyles labelStyle, const QColor &color );
